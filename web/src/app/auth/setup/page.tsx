    ...
    <div className="min-h-screen flex items-center justify-center px-4">
      <div className="w-full max-w-md">
        <div className="text-center mb-6">
          <Code2 className="w-10 h-10 text-cyan-500 dark:text-cyan-400 mx-auto" />
        </div>
        ...
        <div className="xp-panel overflow-hidden">
          ...
          {error && (
            <div className="p-3 rounded-sm bg-red-500/10 border border-red-500/20 text-red-400 text-sm mb-4">
              {error}
            </div>
          )}
          ...
          {step === "input" && (
            <form onSubmit={handleStartVerification} className="space-y-4">
              ...
              <button
                type="submit"
                disabled={loading}
                className="w-full py-2.5 rounded-sm xp-btn-primary disabled:opacity-50 disabled:cursor-not-allowed font-medium transition-colors flex items-center justify-center gap-2"
              >
          ...
          {step === "token" && (
            <div className="space-y-4">
              <div className="p-3 rounded-sm bg-cyan-500/10 border border-cyan-500/20 text-cyan-600 dark:text-cyan-400 text-sm">
              ...
              <div className="flex items-center gap-2 bg-gray-100 dark:bg-gray-800 rounded-sm p-3 border border-gray-300 dark:border-gray-700">
                <code className="flex-1 text-center font-mono text-lg text-cyan-600 dark:text-cyan-400 select-all">{token}</code>
                <button
                  onClick={copyToken}
                  className="flex-shrink-0 p-1.5 rounded-sm hover:bg-gray-200 dark:hover:bg-gray-700 transition-colors"
                  title="Copy token"
                >
