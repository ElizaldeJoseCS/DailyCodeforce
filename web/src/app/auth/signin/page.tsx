    ...
    <div className="min-h-screen flex items-center justify-center px-4">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <p className="text-gray-400 mt-2">Track your progress and streaks</p>
        </div>
        ...
        <div className="rounded-xl border border-gray-800 bg-gray-900/50 p-8">
          ...
          <div className="mt-4">
            ...
            <button
              ...
              className="mt-4 w-full py-2.5 rounded-lg bg-[#5865F2] hover:bg-[#4752C4] font-medium transition-colors flex items-center justify-center gap-2"
            >
